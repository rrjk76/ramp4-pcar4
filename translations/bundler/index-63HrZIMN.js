...
import { _ as H, d as L, F as K, G as X } from "./main-DtKj__VK.js";
...
const W = /* @__PURE__ */ H(te, [["render", ne]]), ie = /* @__PURE__ */ O({
  ...
  setup(b) {
    const i = S("iApi"), { t } = N(), o = ee(), p = [
      {
        type: "point",
        icon: f(g(() => import("./point-icon-IH0Ju7pt.js")))
      },
      {
        type: "polyline",
        icon: f(g(() => import("./polyline-icon-CfvsbL8o.js")))
      },
      {
        type: "polygon",
        icon: f(g(() => import("./polygon-icon-XBG_byHb.js")))
      },
      {
        type: "circle",
        icon: f(g(() => import("./circle-icon-BHMdWkmQ.js")))
      },
      {
        type: "rectangle",
        icon: f(g(() => import("./rectangle-icon-BMZwRLv7.js")))
      }
    ], a = E(() => {
      const s = p.filter((v) => o.supportedTypes.some((x) => x.type === v.type));
      return s.push({
        type: "edit",
        icon: f(g(() => import("./edit-icon-B8zv2Q_c.js")))
      }), s;
    }), n = (s) => {
