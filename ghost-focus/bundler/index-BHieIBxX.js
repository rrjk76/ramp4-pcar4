...
import { _ as H, d as L, F as X, G as ee } from "./main-DvPcsJjd.js";
...
const G = /* @__PURE__ */ H(ne, [["render", ae]]), se = /* @__PURE__ */ T({
  ...
  setup(h) {
    ...
    const p = [
      {
        type: "point",
        icon: g(_(() => import("./point-icon-Dbx_aDyt.js")))
      },
      {
        type: "polyline",
        icon: g(_(() => import("./polyline-icon-B2YjVofl.js")))
      },
      {
        type: "polygon",
        icon: g(_(() => import("./polygon-icon-BTLscttL.js")))
      },
      {
        type: "circle",
        icon: g(_(() => import("./circle-icon-B6U0jqG3.js")))
      },
      {
        type: "rectangle",
        icon: g(_(() => import("./rectangle-icon-DQyAAZP_.js")))
      }
    ], a = A(() => {
      const s = p.filter((u) => e.supportedTypes.some((x) => x.type === u.type));
      return s.push({
        type: "edit",
        icon: g(_(() => import("./edit-icon-CJ_FD064.js")))
      }), s;
    }), n = (s) => {
