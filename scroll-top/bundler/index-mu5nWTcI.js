...
import { _ as H, d as L, F as X, G as ee } from "./main-DmwI3_nF.js";
...
const G = /* @__PURE__ */ H(oe, [["render", ie]]), ae = /* @__PURE__ */ S({
  ...
  setup(f) {
    ...
    const p = [
      {
        type: "point",
        icon: g(_(() => import("./point-icon-CR2LwnSp.js")))
      },
      {
        type: "polyline",
        icon: g(_(() => import("./polyline-icon-CSoz2Fp_.js")))
      },
      {
        type: "polygon",
        icon: g(_(() => import("./polygon-icon-C5JDXLLO.js")))
      },
      {
        type: "circle",
        icon: g(_(() => import("./circle-icon-5oFlcic_.js")))
      },
      {
        type: "rectangle",
        icon: g(_(() => import("./rectangle-icon-2RBBNN1B.js")))
      }
    ], a = A(() => {
      const s = p.filter((u) => e.supportedTypes.some((x) => x.type === u.type));
      return s.push({
        type: "edit",
        icon: g(_(() => import("./edit-icon-CdSVxjQf.js")))
      }), s;
    }), n = (s) => {
