import { defineComponent as G, ref as b, onMounted as oe, createElementBlock as a, openBlock as s, createElementVNode as g, normalizeClass as Z, createCommentVNode as B, Fragment as X, renderList as Q, normalizeStyle as ge, toDisplayString as j, computed as w, resolveDirective as q, withDirectives as A, withModifiers as he, createVNode as ie, onBeforeMount as ee, watch as R, onBeforeUnmount as te, unref as L, createBlock as Y, inject as se, resolveDynamicComponent as me, createTextVNode as ne, resolveComponent as Me, withCtx as pe, nextTick as fe } from "vue";
import { _ as re, e as le, X as ue, L as Ie, Y as Ce, G as K } from "./main-DmwI3_nF.js";
...
import { T as ze } from "./toggle-switch-control-BBkX8p9X.js";
import "pinia";
import "screenfull";
...
const De = {
  ...
  key: 0,
  class: "relative"
}, He = ["innerHTML"], je = ["src"], Be = {
  key: 1,
  class: "w-32 h-32"
}, Oe = { class: "symbologyIcon" }, Ne = ["innerHTML"], Ae = ["src"], qe = { class: "badge z-50 rounded-full text-white absolute h-10 w-10 p-8 inline-flex items-center justify-center" }, Fe = {
  key: 0,
  class: "px-5"
}, Pe = {
  key: 1,
  ...
  setup(m) {
    ...
    return oe(() => {
    ...
    }), (v, y) => m.result.loaded ? (s(), a("div", De, [
      g("div", {
        class: Z(m.result.items.length === 0 ? "opacity-50" : "")
      }, [
        l.value.length > 1 ? (s(), a("div", Se, [
          (s(!0), a(X, null, Q(l.value.slice(0, 3).reverse(), (h, p) => (s(), a("div", {
            ...
            }, null, 8, He)) : l.value[p].imgUrl ? (s(), a("img", {
              key: 1,
              class: "symbologyIcon w-28 h-28",
          ...
          g("div", Oe, [
            ...
            }, null, 8, Ne)) : l.value[0].imgUrl ? (s(), a("img", {
              key: 1,
      ...
      g("div", qe, [
        m.result.loaded ? (s(), a("div", Fe, j(m.result.items.length), 1)) : B("", !0)
      ])
    ])) : (s(), a("div", Pe, y[0] || (y[0] = [
...
}), Ue = /* @__PURE__ */ re(Ge, [["__scopeId", "data-v-496d788d"]]), Ve = ["content"], Re = { class: "symbologyLayerName truncate" }, Ze = /* @__PURE__ */ G({
  ...
  setup(m, { emit: E }) {
    ...
    return ee(() => {
      ...
      const $ = q("focus-item"), F = q("focus-list"), M = q("tippy");
      return A((s(), a("div", {
        ...
        (s(!0), a(X, null, Q(z.results, (N, t) => (s(), a("div", {
...
}), Xe = { class: "inline font-bold" }, Je = ["innerHTML"], Ke = /* @__PURE__ */ G({
  __name: "esri-default",
  props: {
    fixtureFields: {
      type: Object,
...
}), Qe = ["innerHTML"], et = { key: 1 }, tt = /* @__PURE__ */ G({
  __name: "html-default",
  props: {
    identifyData: {
      type: Object,
  ...
  setup(m) {
    ...
    }, null, 8, Qe)) : (s(), a("div", et, j(L(E)("details.layers.results.empty")), 1));
  }
}), st = { class: "relative flex flex-grow truncate" }, lt = {
  key: 0,
  class: "flex flex-grow items-center truncate"
}, at = { class: "flex p-8 items-center" }, it = ["innerHTML"], nt = {
  key: 1,
  class: "symbologyIcon p-6"
}, ot = ["content", "innerHTML", "tabindex"], rt = {
  key: 1,
  class: "flex p-6 flex-grow"
}, ut = {
  key: 2,
  class: "zoomButton text-center p-3"
}, ct = ["content", "aria-label"], dt = {
  key: 0,
  ...
  setup(m) {
    const E = ue(), l = m, v = se("iApi"), y = b([]), h = le(), { t: p } = W(), D = b(!1), z = b(""), e = b("none"), u = b(), o = () => E.getLayerByUid(l.uid), n = w(() => h.properties), f = w(() => h.defaultTemplates), c = w(() => o()?.supportsFeatures ?? !1), _ = w(() => o()?.mapLayer ?? !1), O = w(() => {
      const t = o();
      ...
      M("none"), l.data.loaded ? r() : l.data.load().then(() => {
        r();
      });
    }, r = () => {
      ...
      if (d) {
        if (typeof me(d) != "string")
          return d;
        console.error(`Could not find custom details template named ${d}. Was it registered correctly?`);
      }
      return f.value && f.value[l.data.format] ? f.value[l.data.format] : c.value ? Ke : tt;
      ...
      if (t === void 0 || !t.isLoaded) {
        console.warn(`Could not find layer for uid ${l.uid} during zoom geometry lookup`), M("error");
        return;
      }
      if (!l.data.loaded) {
      ...
      const d = l.data.data[t.oidField], C = () => {
        const I = { getGeom: !0 };
        t.getGraphic(d, I).then((x) => {
          x.geometry.invalid() ? (console.error(`Could not find graphic for objectid ${d}`), M("error")) : (v.geo.map.zoomMapTo(x.geometry), M("zoomed"), v.updateAlert(v.$i18n.t("details.item.alert.zoom")));
        }).catch(() => {
          M("error");
        });
      };
      t.layerType === Ie.FEATURE && t.geomType !== Ce.POINT ? t.getGraphicExtent(d).then((I) => {
        v.geo.map.zoomMapTo(I), M("zoomed"), v.updateAlert(v.$i18n.t("details.item.alert.zoom"));
      }).catch(() => {
        C();
      }) : C();
    };
      ...
      return s(), a(X, null, [
        g("div", st, [
          c.value ? (s(), a("div", lt, [
            ...
            ]) : (s(), a("div", rt, j(L(p)("details.loading")), 1)),
            m.data.loaded ? (s(), a("span", ut, [
              _.value ? A((s(), a("button", {
                ...
                e.value === "zooming" ? (s(), a("div", dt)) : e.value === "zoomed" ? (s(), a("svg", vt, d[4] || (d[4] = [
                  g("path", {
                    "stroke-linecap": "round",
                    "stroke-linejoin": "round",
                    d: "M4.5 12.75l6 6 9-13.5"
                  }, null, -1)
                ]))) : e.value === "error" ? (s(), a("svg", mt, d[5] || (d[5] = [
                  g("path", {
                    "stroke-linecap": "round",
                    "stroke-linejoin": "round",
        ...
        m.open ? (s(), Y(me(T.value), {
          key: 0,
          identifyData: m.data,
          fields: $.value,
          fixtureFields: F.value,
          class: "p-8"
        }, null, 8, ["identifyData", "fields", "fixtureFields"])) : B("", !0)
      ], 64);
    };
  }
}), ft = {
...
}, _t = { class: "flex" }, bt = ["aria-label"], kt = ["content", "aria-label", "disabled"], xt = { class: "px-3 text-center flex-grow" }, Lt = ["content", "aria-label", "disabled"], wt = { key: 3 }, Tt = { key: 0 }, $t = ["content"], Et = ["onClick"], Mt = {
  key: 1,
  class: "text-center"
}, It = {
  key: 4,
  ...
  setup(m, { emit: E }) {
    const l = b(), v = () => {
    ...
    }, h = se("iApi"), p = le(), D = ue(), z = E, e = m, { t: u } = W(), o = b(!1), n = b(h.fixture.get("details")), f = b(!0), c = b(!1), _ = b(0), O = b(20), S = b([]), H = b([]), r = w(() => p.activeGreedy), T = w(() => p.properties), $ = w(() => _.value + O.value), F = () => D.getLayerByUid(e.uid), M = () => e.results.find((i) => i.uid === e.uid), N = w(() => M()?.loaded ?? !1), t = w(() => M()?.requestTime), d = w(
      () => o.value && (!c.value && x().length > 1 || c.value && x().length > O.value)
    ), C = w(() => {
      const i = F();
      ...
      c.value ? (_.value += i * O.value, P()) : _.value += i;
    }, P = async (i = !1) => {
      if (f.value && ce.value) {
        if (i) {
          const V = M();
        ...
        if (N.value && k.length > 0) {
          if (c.value)
            ...
            const V = k[_.value];
            V && n.value.hilightDetailsItems([V], e.uid);
          }
          return;
        }
      }
      ...
      c.value = !0, _.value = Math.floor(_.value / O.value) * O.value, P();
    }, Le = () => {
    ...
    return oe(() => {
      ...
      const V = q("truncate"), ae = q("tippy"), $e = q("focus-item"), Ee = q("focus-list");
      return N.value && r.value === 0 ? (s(), a("div", {
        key: 0,
        ...
        ce.value ? (s(), a("div", yt, [
          g("label", gt, j(L(u)("details.togglehilight.title")), 1),
          ie(ze, {
            config: {
              value: f.value,
              disabled: !1
        ...
        d.value ? (s(), a("div", ht, [
          g("div", _t, [
            ...
            g("div", {
              ...
              g("span", xt, j(c.value ? L(u)("details.items.range", [
                _.value + 1,
        ...
        o.value ? (s(), a("div", wt, [
          x().length > 0 ? (s(), a("div", Tt, [
            c.value ? A((s(), a("div", {
              ...
              (s(!0), a(X, null, Q(x().slice(_.value, $.value), (J, ve) => A((s(), a("button", {
                class: "flex flex-grow truncate default-focus-style hover:bg-gray-200",
                key: ve,
                onClick: (Ht) => Te(_.value + ve)
              }, [
                ie(ye, {
                  data: J,
                  uid: m.uid,
        ...
        ])) : (s(), a("div", It, j(L(u)("details.item.no.data")), 1))
      ], 4)) : (s(), a("div", {
        key: 1,
        ...
        ne(" " + j(L(u)("details.item.loading")), 1)
      ], 2));
    };
  }
}), zt = /* @__PURE__ */ re(Ct, [["__scopeId", "data-v-60b1b8a2"]]), Dt = { class: "relative h-full" }, St = /* @__PURE__ */ G({
  ...
  setup(m) {
    const { t: E } = W(), l = se("iApi"), v = le(), y = b([]), h = b([]), p = b([]), D = b(!1), z = b(null), e = b(""), u = w(() => v.activeGreedy), o = w(() => v.payload), n = w(() => v.properties), f = (r) => {
      ...
      r !== void 0 && (v.activeGreedy = r.length === 0 ? 0 : r[0].requestTime, p.value = r, O(r));
    }, O = (r) => {
      if (e.value) {
        const T = c(e.value);
        T ? T.loading.then(() => {
      ...
      if (T)
        ...
        const t = v.properties, d = r.map((I) => [
          t[I.layerId]?.priority ?? 50,
          I.layerId
        ]), C = new Set(d.map((I) => I[0]));
        $ = [], C.forEach((I) => {
          const x = d.filter((U) => U[0] === I).map((U) => U[1]);
          $.push([I, x]);
        }), $.sort((I, x) => x[0] - I[0]);
      }
      if ($.length === 0) {
        o.value.length ? H(!0) : fe().then(() => {
          H(!0);
        });
        return;
      }
      const F = $[$.length - 1][1], M = r.filter((t) => F.includes(t.layerId)).map(
        (t) => t.loading.then(() => t.items.length > 0 ? Promise.resolve(t) : Promise.reject())
      ), N = r.length === 0 ? 0 : r[0].requestTime;
      Promise.any(M).then((t) => {
    ...
    return ee(() => {
      ...
      return s(), Y($, { panel: m.panel }, {
        ...
        content: pe(() => [
          g("div", Dt, [
            p.value.length > 1 ? (s(), Y(We, {
              key: 0,
              results: p.value,
              detailsProperties: n.value,
              selected: e.value,
              onSelectionChanged: f
            }, null, 8, ["results", "detailsProperties", "selected"])) : B("", !0),
            g("div", {
              ...
              }, j(p.value.length >= 1 ? L(E)("details.layers.results.empty") : L(E)("details.layers.results.empty.noLayers")), 3)) : (s(), Y(zt, {
                key: 0,
                uid: e.value,
                results: p.value,
                onItemSelected: T[0] || (T[0] = () => fe(() => z.value?.scrollTo({ top: 0 })))
              }, null, 8, ["uid", "results"]))
            ], 512)
          ])
        ]),
...
}), hs = /* @__PURE__ */ re(St, [["__scopeId", "data-v-e4b92b97"]]);
export {
  hs as default
};
