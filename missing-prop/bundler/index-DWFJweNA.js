...
import "tiny-emitter";
import { G as le, L as Te, F as xe } from "./main-BxOQKFlR.js";
...
class ft extends Me {
  async init() {
    Object.entries(Le).forEach((b) => this.$iApi.$i18n.mergeLocaleMessage(...b)), this._parseConfig(this.config), Z(this.$vApp.$pinia).supportedTypes.forEach((b) => {
      const o = `${b.type}-icon`;
      this.$iApi.component(o, Ae(Se(/* @__PURE__ */ Object.assign({ "./icons/circle-icon.vue": () => import("./circle-icon-DpcNAdWt.js"), "./icons/edit-icon.vue": () => import("./edit-icon-DxDSFAYb.js"), "./icons/point-icon.vue": () => import("./point-icon-BeVhnXr1.js"), "./icons/polygon-icon.vue": () => import("./polygon-icon-arDaxtFZ.js"), "./icons/polyline-icon.vue": () => import("./polyline-icon-CX4OHiK7.js"), "./icons/rectangle-icon.vue": () => import("./rectangle-icon-DKeDomeU.js") }), `./icons/${b.type}-icon.vue`, 3)));
    });
