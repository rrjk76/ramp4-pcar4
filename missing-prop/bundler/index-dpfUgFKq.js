...
import { _ as H, d as L, F as X, G as ee } from "./main-BxOQKFlR.js";
...
const G = /* @__PURE__ */ H(oe, [["render", ie]]), ae = /* @__PURE__ */ S({
  ...
  setup(f) {
    ...
    const p = [
      {
        type: "point",
        icon: g(_(() => import("./point-icon-BeVhnXr1.js")))
      },
      {
        type: "polyline",
        icon: g(_(() => import("./polyline-icon-CX4OHiK7.js")))
      },
      {
        type: "polygon",
        icon: g(_(() => import("./polygon-icon-arDaxtFZ.js")))
      },
      {
        type: "circle",
        icon: g(_(() => import("./circle-icon-DpcNAdWt.js")))
      },
      {
        type: "rectangle",
        icon: g(_(() => import("./rectangle-icon-DKeDomeU.js")))
      }
    ], a = A(() => {
      const s = p.filter((u) => e.supportedTypes.some((x) => x.type === u.type));
      return s.push({
        type: "edit",
        icon: g(_(() => import("./edit-icon-DxDSFAYb.js")))
      }), s;
    }), n = (s) => {
