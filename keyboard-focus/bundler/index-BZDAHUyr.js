...
import { _ as H, d as L, F as K, G as X } from "./main-DZdo46-f.js";
...
const W = /* @__PURE__ */ H(te, [["render", ne]]), ie = /* @__PURE__ */ O({
  ...
  setup(b) {
    const i = S("iApi"), { t } = N(), o = ee(), p = [
      {
        type: "point",
        icon: f(g(() => import("./point-icon-B1VXbQWd.js")))
      },
      {
        type: "polyline",
        icon: f(g(() => import("./polyline-icon-BaANYnzV.js")))
      },
      {
        type: "polygon",
        icon: f(g(() => import("./polygon-icon-CAVTrWlt.js")))
      },
      {
        type: "circle",
        icon: f(g(() => import("./circle-icon-BroFTP0y.js")))
      },
      {
        type: "rectangle",
        icon: f(g(() => import("./rectangle-icon-DnafnMmp.js")))
      }
    ], a = E(() => {
      const s = p.filter((v) => o.supportedTypes.some((x) => x.type === v.type));
      return s.push({
        type: "edit",
        icon: f(g(() => import("./edit-icon-CS5sOJ36.js")))
      }), s;
    }), n = (s) => {
