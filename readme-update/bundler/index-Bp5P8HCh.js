...
import "tiny-emitter";
import { G as re, L as ve, F as be } from "./main-fKgGRrGi.js";
...
class ut extends xe {
  async init() {
    ...
    this.$vApp.$el.getElementsByClassName("inner-shell")[0].appendChild(r.childNodes[0]), Object.entries(Pe).forEach((t) => this.$iApi.$i18n.mergeLocaleMessage(...t)), this._parseConfig(this.config), Y(this.$vApp.$pinia).supportedTypes.forEach((t) => {
      const n = `${t.type}-icon`;
      this.$iApi.component(n, fe(Ae(/* @__PURE__ */ Object.assign({ "./icons/circle-icon.vue": () => import("./circle-icon-D0uAQDn3.js"), "./icons/edit-icon.vue": () => import("./edit-icon-3BtB0XlY.js"), "./icons/point-icon.vue": () => import("./point-icon-C_rUPFrm.js"), "./icons/polygon-icon.vue": () => import("./polygon-icon-DWy3A3_p.js"), "./icons/polyline-icon.vue": () => import("./polyline-icon-B3keMfVO.js"), "./icons/rectangle-icon.vue": () => import("./rectangle-icon-BHc8Qu2k.js") }), `./icons/${t.type}-icon.vue`, 3)));
    });
  }
  async added() {
