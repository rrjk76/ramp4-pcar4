...
import { _ as C, d as A, F as j, G } from "./main-fKgGRrGi.js";
...
const D = /* @__PURE__ */ C(q, [["render", U]]), W = /* @__PURE__ */ $({
  ...
  setup(_) {
    const i = k("iApi"), { t } = z(), e = Y(), o = [
      {
        type: "point",
        icon: h(f(() => import("./point-icon-C_rUPFrm.js")))
      },
      {
        type: "polyline",
        icon: h(f(() => import("./polyline-icon-B3keMfVO.js")))
      },
      {
        type: "polygon",
        icon: h(f(() => import("./polygon-icon-DWy3A3_p.js")))
      },
      {
        type: "circle",
        icon: h(f(() => import("./circle-icon-D0uAQDn3.js")))
      },
      {
        type: "rectangle",
        icon: h(f(() => import("./rectangle-icon-BHc8Qu2k.js")))
      }
    ], d = x(() => {
      const a = o.filter((s) => e.supportedTypes.some((c) => c.type === s.type));
      return a.push({
        type: "edit",
        icon: h(f(() => import("./edit-icon-3BtB0XlY.js")))
      }), a;
    }), n = (a) => {
