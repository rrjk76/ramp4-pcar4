import{E as m,o as p}from"./VertexArrayObject-DFtb_KSH.js";import{R as l,s as u}from"./FramebufferObject-kDt5vhWW.js";import{a as c}from"./ProgramTemplate-BlfyGtRy.js";import{e as d,b as $}from"./ProgramTemplate-BlfyGtRy.js";import"./main-CuW8Kb_K.js";import{t as b}from"./NestedMap-DL9KstBd.js";import{S as h}from"./Texture-DpI-bThB.js";class x{constructor(e){this._rctx=e,this._store=new b}dispose(){this._store.forAll(e=>e.dispose()),this._store.clear()}acquire(e,t,r,i){const s=this._store.get(e,t);if(s!=null)return s.ref(),s;const o=new c(this._rctx,e,t,r,i);return o.ref(),this._store.set(e,t,o),o}get test(){}}function _(n){const{options:e,value:t}=n;return typeof e[t]=="number"}function g(n){let e="";for(const t in n){const r=n[t];if(typeof r=="boolean")r&&(e+=`#define ${t}
