...
import { _ as H, d as L, F as K, G as X } from "./main-ClZ0coU1.js";
...
const G = /* @__PURE__ */ H(te, [["render", ne]]), ie = /* @__PURE__ */ I({
  ...
  setup(f) {
    const i = S("iApi"), { t } = B(), o = ee(), p = [
      {
        type: "point",
        icon: g(_(() => import("./point-icon-Cl7Q-Zq6.js")))
      },
      {
        type: "polyline",
        icon: g(_(() => import("./polyline-icon-Dcp3CnZN.js")))
      },
      {
        type: "polygon",
        icon: g(_(() => import("./polygon-icon-WuRnZ1xy.js")))
      },
      {
        type: "circle",
        icon: g(_(() => import("./circle-icon-B7rTHUtd.js")))
      },
      {
        type: "rectangle",
        icon: g(_(() => import("./rectangle-icon-B56Nat8d.js")))
      }
    ], a = M(() => {
      const s = p.filter((u) => o.supportedTypes.some((x) => x.type === u.type));
      return s.push({
        type: "edit",
        icon: g(_(() => import("./edit-icon-MGatc0v1.js")))
      }), s;
    }), n = (s) => {
