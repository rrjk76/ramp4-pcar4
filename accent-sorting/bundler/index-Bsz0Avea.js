...
import { _ as C, d as A, F as j, G } from "./main-Z2xgn6P-.js";
...
const D = /* @__PURE__ */ C(q, [["render", U]]), W = /* @__PURE__ */ $({
  ...
  setup(_) {
    const i = k("iApi"), { t } = z(), e = Y(), o = [
      {
        type: "point",
        icon: h(f(() => import("./point-icon-CfnvEerz.js")))
      },
      {
        type: "polyline",
        icon: h(f(() => import("./polyline-icon-bTLHWQwW.js")))
      },
      {
        type: "polygon",
        icon: h(f(() => import("./polygon-icon-EL7wv8VP.js")))
      },
      {
        type: "circle",
        icon: h(f(() => import("./circle-icon-DcrBZRz3.js")))
      },
      {
        type: "rectangle",
        icon: h(f(() => import("./rectangle-icon-GssI7MIs.js")))
      }
    ], d = x(() => {
      const a = o.filter((s) => e.supportedTypes.some((c) => c.type === s.type));
      return a.push({
        type: "edit",
        icon: h(f(() => import("./edit-icon-DXk1XMDO.js")))
      }), a;
    }), n = (a) => {
