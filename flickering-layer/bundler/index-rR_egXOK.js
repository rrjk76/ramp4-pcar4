...
import "tiny-emitter";
import { G as le, L as Te, F as xe } from "./main-D04fyO2j.js";
...
class ft extends Me {
  async init() {
    Object.entries(Le).forEach((b) => this.$iApi.$i18n.mergeLocaleMessage(...b)), this._parseConfig(this.config), Z(this.$vApp.$pinia).supportedTypes.forEach((b) => {
      const o = `${b.type}-icon`;
      this.$iApi.component(o, Ae(Se(/* @__PURE__ */ Object.assign({ "./icons/circle-icon.vue": () => import("./circle-icon-dr32ojAl.js"), "./icons/edit-icon.vue": () => import("./edit-icon-Bc2N4TDA.js"), "./icons/point-icon.vue": () => import("./point-icon-f7Xv_euY.js"), "./icons/polygon-icon.vue": () => import("./polygon-icon-CM65nocf.js"), "./icons/polyline-icon.vue": () => import("./polyline-icon-BFBDdxnh.js"), "./icons/rectangle-icon.vue": () => import("./rectangle-icon-DXy7SEEg.js") }), `./icons/${b.type}-icon.vue`, 3)));
    });
