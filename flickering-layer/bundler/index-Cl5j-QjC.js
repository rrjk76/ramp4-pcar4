...
import { _ as H, d as L, F as X, G as ee } from "./main-D04fyO2j.js";
...
const G = /* @__PURE__ */ H(ne, [["render", ae]]), se = /* @__PURE__ */ T({
  ...
  setup(h) {
    ...
    const p = [
      {
        type: "point",
        icon: g(_(() => import("./point-icon-f7Xv_euY.js")))
      },
      {
        type: "polyline",
        icon: g(_(() => import("./polyline-icon-BFBDdxnh.js")))
      },
      {
        type: "polygon",
        icon: g(_(() => import("./polygon-icon-CM65nocf.js")))
      },
      {
        type: "circle",
        icon: g(_(() => import("./circle-icon-dr32ojAl.js")))
      },
      {
        type: "rectangle",
        icon: g(_(() => import("./rectangle-icon-DXy7SEEg.js")))
      }
    ], a = A(() => {
      const s = p.filter((u) => e.supportedTypes.some((x) => x.type === u.type));
      return s.push({
        type: "edit",
        icon: g(_(() => import("./edit-icon-Bc2N4TDA.js")))
      }), s;
    }), n = (s) => {
