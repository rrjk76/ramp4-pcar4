  ...
  defaultHandlerFactory(e) {
    ...
    switch (e) {
      ...
      case "ramp_map_basemap_checks_tile_proj":
        t = (i) => {
          i.schemaChanged && this.$iApi.geo.layer.allLayers().filter((s) => s.dataFormat === ce.ESRI_TILE && s.schemaLocked).forEach((s) => {
            s.checkProj();
          });
...
class We extends as {
  ...
  handlers = [];
  symbolSql = "";
  // symbol filter SQL used for visibility toggling
  /**
  ...
  toggleVisibility(e, t = !0, i = !1) {
    if (!(!this.layerControlAvailable(X.Visibility) && !i) && (super.toggleVisibility(e, t), this.layer && this.layer.layerExists)) {
      this.layer.supportsFeatures && this.layer.mapLayer && this.layer.visibility && this.layer.canModifyLayer ? this.visibility ? this.layer.setSqlFilter(le.SYMBOL, this.symbolSql !== "1=2" ? this.symbolSql : "") : this.layer.setSqlFilter(le.SYMBOL, "1=2") : this.layer.visibility = this.visibility;
      const s = this._symbologyStack.some((a) => a.lastVisbility);
      this._symbologyStack.forEach((a) => {
        !s && this.visibility && (a.lastVisbility = !0), a.visibility = this.visibility ? a.lastVisbility : !1;
      });
    }
  }
  /**
  ...
  clickSymbology(e, t) {
    if (!this.symbolsVisible() && t !== !1 ? (this.setSymbologyVisibility(void 0, !1), this.setSymbologyVisibility(e, !0), this.toggleVisibility(!0)) : this.setSymbologyVisibility(e, t), this.symbolsVisible() || this.toggleVisibility(!1), this.layer?.supportsFeatures) {
      ...
      let s = "";
      i.length === 0 ? s = "1=2" : i.length < this.symbologyStack.length && (s = i.join(" OR ")), this.symbolSql = s, this.layer.setSqlFilter(le.SYMBOL, s);
    }
  }
  /**
...
class Rn extends re {
  ...
  async loadLayerMetadata(e) {
    ...
    if (a.name = s.name || "", a.currentVersion = s.currentVersion || -1, a.minScale = s.effectiveMinScale || s.minScale || 0, a.maxScale = s.effectiveMaxScale || s.maxScale || 0, a.extent = s.extent ? H.fromArcServer(s.extent, "layer_extent") : void 0, a.defaultVisibility = s.defaultVisibility ?? !0, a.canModifyLayer = s.canModifyLayer ?? !0, s.type === "Feature Layer" || s.type === "Table") {
      if (a.dataFormat = ce.ESRI_FEATURE, a.displayField = s.displayField || "", Array.isArray(s.fields)) {
...
class os extends ci {
  ...
  constructor(e, t) {
    super(e, t), this.name = e.name || "", this.geomType = $.NONE, this.dataFormat = ce.UNKNOWN, this.layerType = S.UNKNOWN, this.layerFormat = ge.UNKNOWN;
...
class $n extends at {
  constructor(e, t) {
    super(e, t), this.dataFormat = ce.ESRI_FEATURE, this.layerFormat = ge.GRAPHIC, this.maptips = !1;
  }
  _graphics = [];
  /**
   * Take a layer config from the RAMP application and derives a configuration for an ESRI layer
...
class ot extends ui {
  ...
  sourceGeoJson;
  constructor(e, t) {
    super(e, t), this.supportsIdentify = !0, this.isFile = !0, this.dataFormat = ce.ESRI_FEATURE, this.layerFormat = ge.FEATURE, this.layerIdx = 0, e.identifyMode && e.identifyMode !== oe.NONE ? this.identifyMode = e.identifyMode : this.identifyMode = oe.HYBRID;
  }
  async reload() {
...
class Dn extends ui {
  constructor(e, t) {
    super(e, t), this.dataFormat = ce.ESRI_FEATURE, this.supportsIdentify = !0, this.layerType = S.FEATURE, this.layerFormat = ge.FEATURE, e.identifyMode && e.identifyMode !== oe.NONE ? this.identifyMode = e.identifyMode : this.identifyMode = oe.HYBRID;
  }
  async onInitiate() {
...
class Un extends ui {
  constructor(e, t, i) {
    if (super(e, t), this.layerType = S.SUBLAYER, this.layerFormat = ge.MAPIMAGE, this.isSublayer = !0, this.layerIdx = e.index, this.parentLayer = i, this.isSystem = i.isSystem, this.dataFormat = ce.ESRI_FEATURE, this.supportsFeatures = !0, this.maptips = !1, this.url = this.parentLayer?.url, this.canReload = !!(this.url || this.origRampConfig.caching), !i.esriLayer)
...
class Vn extends at {
  constructor(e, t) {
    super(e, t), this.supportsIdentify = !1, this.layerType = S.OSM, this.layerFormat = ge.OSM, this.dataFormat = ce.OSM_TILE, this.supportsFeatures = !1;
  }
  async onInitiate() {
...
class Bn extends at {
  constructor(e, t) {
    super(e, t), this.supportsIdentify = !1, this.layerType = S.IMAGERY, this.layerFormat = ge.IMAGERY, this.dataFormat = ce.ESRI_RASTER;
  }
  async onInitiate() {
...
class pi extends at {
  ...
  schemaLocked = !0;
  constructor(e, t) {
    super(e, t), this.supportsIdentify = !1, this.dataFormat = ce.ESRI_TILE;
  }
  onLoadActions() {
    const e = super.onLoadActions();
...
class Hn extends at {
  ...
  mimeType;
  constructor(e, t) {
    super(e, t), this.supportsIdentify = !0, this.layerType = S.WMS, this.layerFormat = ge.WMS, this.mimeType = e.featureInfoMimeType || "", this.sublayerNames = [], this.dataFormat = ce.OGC_RASTER, this.identifyMode = oe.GEOMETRIC;
  }
  async onInitiate() {
...
class ns extends os {
  ...
  // ----------- LAYER CONSTRUCTION AND INITIALIZAION -----------
  constructor(e, t) {
    super(e, t), this.dataFormat = ce.ESRI_FEATURE, this.layerFormat = ge.NOLAYER, this.drawState = ye.NOT_VISUAL, this.attribs = new ls(), this.supportsFeatures = !0, this.mapLayer = !1, this.isFile = !1, this._visibility = e.state?.visibility ?? !0, this.expectedTime.draw = 0;
  }
  async onInitiate() {
    if (this.sourceJson) {
...
class Zn extends re {
  ...
  async generateTabularAttributesWorker(e, t) {
    if (e.dataFormat === ce.ESRI_RASTER)
...
const ol = /* @__PURE__ */ Object.assign({ "../fixtures/appbar/index.ts": () => import("./index-JnaBAirk.js"), "../fixtures/areas-of-interest/index.ts": () => import("./index-C2WDUC48.js"), "../fixtures/basemap/index.ts": () => import("./index-ZPLj7RIx.js"), "../fixtures/crosshairs/index.ts": () => import("./index-vFa_a474.js"), "../fixtures/details/index.ts": () => import("./index-DOIPfQD6.js"), "../fixtures/draw/index.ts": () => import("./index-rR_egXOK.js"), "../fixtures/export-footnote/index.ts": () => import("./index-Dz_iwTyp.js"), "../fixtures/export-legend/index.ts": () => import("./index-D99FEZyW.js"), "../fixtures/export-map/index.ts": () => import("./index-B16zj-V0.js"), "../fixtures/export-northarrow/index.ts": () => import("./index-fUAJprXr.js"), "../fixtures/export-scalebar/index.ts": () => import("./index-lGyncTf5.js"), "../fixtures/export-timestamp/index.ts": () => import("./index-P-rQGgO2.js"), "../fixtures/export-title/index.ts": () => import("./index-BdSblkOE.js"), "../fixtures/export/index.ts": () => import("./index-CqqmjrfX.js"), "../fixtures/extentguard/index.ts": () => import("./index-B2fvk6jZ.js"), "../fixtures/gazebo/index.ts": () => import("./index-BVn3wkd_.js"), "../fixtures/geosearch/index.ts": () => import("./index-CbImQzSQ.js"), "../fixtures/grid/index.ts": () => import("./index-BaIzL6qY.js"), "../fixtures/help/index.ts": () => import("./index-B13e0__r.js"), "../fixtures/hilight/index.ts": () => import("./index-B1-NJObP.js"), "../fixtures/keyboardnav/index.ts": () => import("./index-L1DTKv2B.js"), "../fixtures/layer-reorder/index.ts": () => import("./index-DLl4UY6t.js"), "../fixtures/legend/index.ts": () => import("./index-B1bwAr2J.js"), "../fixtures/mapnav/index.ts": () => import("./index-Cl5j-QjC.js"), "../fixtures/metadata/index.ts": () => import("./index-CA0kUSrs.js"), "../fixtures/northarrow/index.ts": () => import("./index-4GQhcIZD.js"), "../fixtures/overviewmap/index.ts": () => import("./index-DbSdXGC2.js"), "../fixtures/panguard/index.ts": () => import("./index-DQbuSmv2.js"), "../fixtures/scrollguard/index.ts": () => import("./index-8wpXZH5V.js"), "../fixtures/settings/index.ts": () => import("./index-BmuRHuzs.js"), "../fixtures/snowman/index.ts": () => import("./index-C3REO9f5.js"), "../fixtures/swipe/index.ts": () => import("./index-Bqo1V-mM.js"), "../fixtures/wizard/index.ts": () => import("./index-BC4sEEoI.js") });
class nl extends re {
  /**
...
const dl = /* @__PURE__ */ qe(ul, [["render", pl], ["__scopeId", "data-v-a3c61802"]]), hl = /* @__PURE__ */ Object.assign({ "../fixtures/areas-of-interest/screen.vue": () => import("./screen-BDXGSth3.js"), "../fixtures/basemap/screen.vue": () => import("./screen-CHRC7ocA.js"), "../fixtures/export/screen.vue": () => import("./screen-L2iaT8X_.js"), "../fixtures/geosearch/screen.vue": () => import("./screen-CM2_qqdu.js"), "../fixtures/grid/screen.vue": () => import("./screen-Bo7lZtOc.js"), "../fixtures/help/screen.vue": () => import("./screen-Dxz-eXFH.js"), "../fixtures/layer-reorder/screen.vue": () => import("./screen-z0JaSKOX.js"), "../fixtures/legend/screen.vue": () => import("./screen-DeyT3iHn.js"), "../fixtures/metadata/screen.vue": () => import("./screen-BBni0EQC.js"), "../fixtures/settings/screen.vue": () => import("./screen-Dtc4mMs0.js"), "../fixtures/wizard/screen.vue": () => import("./screen-BCHpDUIy.js") });
class Ct extends re {
  /**
   * ID of this panel.
   *
...
var pt = { major: "4", minor: "15", patch: "0-beta", timestamp: "Wed Feb 4 09:31:45 2026 -0500", hash: "cbd8352396b903994c6096722088880ba17a4dc3" };
console.info(
