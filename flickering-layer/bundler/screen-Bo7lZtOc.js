import { defineComponent as G, inject as ie, resolveComponent as Pe, resolveDirective as B, createBlock as tt, openBlock as _, unref as g, withCtx as se, createElementBlock as E, Fragment as lt, renderList as at, createElementVNode as s, withDirectives as A, createTextVNode as ne, toDisplayString as S, normalizeClass as P, ref as w, onBeforeMount as fe, withKeys as H, withModifiers as N, vModelText as oe, vModelSelect as Ft, onMounted as X, nextTick as _e, onBeforeUnmount as J, createCommentVNode as D, computed as I, useTemplateRef as kt, getCurrentInstance as At, watch as Ie, vShow as ae, createVNode as Ee, markRaw as Ge } from "vue";
import "tiny-emitter";
import { a as ge, _ as he, G as Q, W as Tt, X as $t, L as Rt, Y as St, Z as rt, $ as re, i as st, a0 as Dt, a1 as ve, a2 as Xe, a3 as It } from "./main-D04fyO2j.js";
...
import { ModuleRegistry as Ot, AllCommunityModule as zt, provideGlobalGridOptions as Ut } from "ag-grid-community";
...
const Yt = ["onClick"], Zt = { class: "md-icon-small flex w-full" }, Qt = { class: "flex-1 truncate whitespace-nowrap overflow-hidden pr-4" }, Xt = /* @__PURE__ */ G({
  ...
  props: ["params"],
  setup(L) {
    const n = ge(), { t: e } = O(), r = L, l = w(""), i = w(""), c = w(r.params.stateManager.columns[r.params.column.colDef.field].filter.static), u = () => {
...
}), rl = /* @__PURE__ */ he(al, [["__scopeId", "data-v-27003866"]]), sl = { class: "h-full flex items-center justify-center" }, nl = ["placeholder", "aria-label", "disabled"], ol = {
  methods: {
    onParentModelChanged() {
    }
  }
  ...
  props: ["params"],
  setup(L) {
    const n = ge(), { t: e } = O(), r = L, l = w(""), i = w(r.params.stateManager.columns[r.params.column.colDef.field].filter.static), c = () => {
...
}), vl = /* @__PURE__ */ he(ml, [["__scopeId", "data-v-e6bcc33c"]]), fl = { class: "h-full flex items-center justify-center w-full" }, gl = ["placeholder", "aria-label", "disabled"], hl = ["placeholder", "aria-label", "disabled"], yl = {
  methods: {
    onParentModelChanged() {
    }
  }
...
}), wl = /* @__PURE__ */ he(bl, [["__scopeId", "data-v-424baaed"]]), xl = ["content", "disabled", "aria-label"], Cl = /* @__PURE__ */ G({
  __name: "clear-filter",
  props: ["params"],
  setup(L) {
  ...
  setup(L) {
    ...
    return X(() => {
      ...
      return _(), E("div", {
        ...
        i.value ? (_(), E("div", Ml, [
          L.params.enableSorting && l.value === 0 ? (_(), E("span", Fl)) : D("", !0),
...
}), Sl = ["content", "aria-label"], Dl = /* @__PURE__ */ G({
  ...
  props: ["params"],
  setup(L) {
    const n = w("none"), e = L, r = ie("iApi"), l = $t(), i = w(), { t: c } = O(), u = I(() => {
      ...
      C.layerType === Rt.FEATURE && C.geomType !== St.POINT ? C.getGraphicExtent(x).then((M) => {
...
}), Bl = ["content"], Ol = ["innerHTML"], zl = /* @__PURE__ */ G({
  ...
  props: ["params"],
  setup(L) {
    const n = ge(), e = ie("iApi"), { t: r } = O(), l = w(), i = w(), c = w(!1), u = L, m = I(() => n.mobileView), h = () => {
  ...
  width: "18",
  viewBox: "0 0 24 24"
}, Ea = ["aria-label"], Ma = { class: "md-icon-small flex flex-nowrap items-center gap-x-4" }, Fa = {
  key: 0,
  xmlns: "http://www.w3.org/2000/svg",
  viewBox: "0 0 24 24",
  ...
  width: "18",
  viewBox: "0 0 24 24"
}, $a = ["aria-label"], Ra = { class: "md-icon-small flex flex-nowrap items-center gap-x-4" }, Sa = { class: "grow" }, Da = ["content"], Ia = /* @__PURE__ */ G({
  ...
  setup(L) {
    Ot.registerModules([zt]), Ut({ theme: "legacy" });
    const n = [re.OID, re.DOUBLE, re.SINGLE, re.INTEGER], e = ie("iApi"), r = st(), l = ge(), i = I(() => l.mobileView), c = w(!i.value), u = w(), m = kt("gridContainer"), { t: h, locale: C } = O(), y = () => At()?.proxy?.$forceUpdate(), x = L, p = w({
      id: "dummy",
      layerIds: [],
      state: new Pt(),
      fieldMap: {}
    }), M = w(!0), $ = w(null), K = w(), ee = w(), j = w(!1), te = w(!1), ue = w([]), Me = w(0), W = w([]), ye = w([]), Fe = w(""), le = w([]), de = w([]), be = w("OBJECTID"), ke = w(void 0), nt = et.onCellKeyPress, z = w({ firstRow: 0, lastRow: 0, visibleRows: 0 }), we = w({}), pe = w({}), He = w(r.grids[x.gridId].layerIds), V = I(() => r.grids[x.gridId] ? r.grids[x.gridId].layerIds.map((a) => e.geo.layer.getLayer(a)).filter((a) => a !== void 0) : []), Ne = I(() => p.value.state.filtered || p.value.state.searchFilter), Ae = w(/* @__PURE__ */ new Set()), xe = w([]), T = I(() => $.value), Ce = () => {
      ...
      () => He.value.some((a) => {
        ...
        return !t || t.layerState !== Dt.LOADED || t.mapLayer && t.getSqlFilter(ve.SYMBOL) === "1=2" ? !1 : t.visibility;
      })
    ), ot = (a) => {
      $.value = a.api;
      let t = p.value.state.title;
      t || (t = e.geo.layer.getLayer(x.gridId)?.name || x.gridId), Fe.value = t, $e(), de.value.length > 0 && T.value.autoSizeAllColumns(), Ce(), T.value.addEventListener("rowDataUpdated", Ce), W.value.push(
        e.event.on(Q.FILTER_CHANGE, ({ uid: v, filterKey: o }) => {
          o !== ve.GRID && v && V.value.map((d) => d.uid).includes(v) && Y();
        })
      ), W.value.push(
        e.event.on(
      ...
      T.value.autoSizeAllColumns(), ke.value = new et(u.value, $.value), Ce();
    }, Te = () => {
      ...
      if (a.field === "rvSymbol") {
        const o = {
          ...
          cellRenderer: (d) => {
            ...
            if (f === void 0) return;
            const F = document.createElement("span"), k = d.data[be.value];
            return f.getIcon(k).then((b) => {
              F.innerHTML = b;
            }), F;
          },
          cellStyle: () => ({
    ...
    }, bt = () => !Object.values(we.value).every((a) => a === void 0), wt = (a) => {
      const t = we.value[a.data.rvUid];
      return t === void 0 || t.includes(a.data[be.value]);
    }, Y = async () => {
      const a = new It(), t = xe.value.slice().map((o) => o.getPromise());
      ...
      const v = xe.value.indexOf(a);
      v === -1 ? console.error("Grid could not find filter blocker in filter queue") : xe.value.splice(v, 1);
    }, xt = () => {
      p.value.state.applyToMap = !p.value.state.applyToMap, Re();
    }, Re = () => {
      V.value.filter((a) => a.mapLayer).forEach((a) => {
        if (!p.value.state.applyToMap)
          a.setSqlFilter(ve.GRID, "");
        else {
          const t = Ct(a.id);
          a.setSqlFilter(ve.GRID, t);
        }
      });
    }, Ct = (a) => {
      ...
      switch (t.filterType) {
        ...
        case "text": {
          ...
          if (v !== "") {
            const o = /\\[(!"#$&'+,.\\/:;<=>?@[\]^`{|}~)]/g;
            let d = v, f = "", F = o.exec(v), k = 0;
            for (; F; )
              f = f + v.substr(k, F.index - k) + F[0].slice(-1), k = F.index + 2, d = v.substr(F.index + 2), F = o.exec(v);
      ...
      T.value.forEachNodeAfterFilterAndSort((F) => {
        o.push(F);
      });
      const d = T.value.getAllDisplayedColumns().filter(
        (F) => (F.colDef.filter === "agTextColumnFilter" || F.colDef.filter === "agNumberColumnFilter") && Se(a, F.getColId())
      ), f = [];
      return o.forEach((F) => {
        let k = !0, b = "";
        for (const R of v) {
          ...
          let ce = !1;
          for (const De of d ?? []) {
            const me = De.getColId(), Le = Se(a, De.getColId())?.origAttr, Qe = De.getColDef();
            if (F.data[me] === void 0)
              ce = !1;
            else if (Qe.filter === "agTextColumnFilter") {
              const Z = F.data[me] === null ? null : F.data[me].toString();
              if (Z !== null && q.test(Z.toUpperCase())) {
                b ? b = b.concat(" AND ", `(UPPER(${Le}) LIKE '${Ze}%')`) : b = b.concat("(", `(UPPER(${Le}) LIKE '${Ze}%')`), f.includes(b + ")") ? ce = !1 : ce = !0;
                break;
              }
            } else if (Qe.filter === "agNumberColumnFilter") {
              const Z = F.data[me] === null ? null : F.data[me];
              if (Z !== null && q.test(Z)) {
                b ? b = b.concat(" AND ", `(${Le} = ${Z})`) : b = b.concat("(", `(${Le} = ${Z})`), ce = !f.includes(b + ")");
                break;
              }
            }
          }
    ...
    ), Se = (a, t) => pe.value[a].find((v) => (v.mappedAttr ?? v.origAttr) === t), qe = () => {
      ...
      a.length === 0 && Ke(), Me.value = a.reduce((t, { featureCount: v }) => t + v, 0), ue.value = new Array(V.value.length).fill(0), a.forEach((t, v) => ue.value[v] += t.downloadedAttributes()), a.forEach((t, v) => {
        ...
        const t = a.map((v) => Ge(v).getTabularAttributes().then((o) => {
          ...
          if (d?.columns && d.columnMetadata?.exclusiveColumns) {
            const f = d.columns.map((F) => F.field);
        ...
        Promise.all(t).then((v) => {
          ...
          v.forEach((d, f) => {
            const F = [], k = a[f].id;
            d.columns.forEach((b) => {
              p.value.fieldMap && p.value.fieldMap[b.data] ? (F.push({
                origAttr: b.data,
                mappedAttr: p.value.fieldMap[b.data]
              }), b.data = p.value.fieldMap[b.data], b.title = b.data) : F.push({
                origAttr: b.data,
                mappedAttr: void 0
            ...
            ), o.oidField = p.value.fieldMap && p.value.fieldMap[d.oidField] ? p.value.fieldMap[d.oidField] : d.oidField, pe.value[k] = F;
          }), be.value = o.oidField, ["rvRowIndex", "rvInteractive", "rvSymbol", ...o.columns].forEach((d) => {
            ...
            const f = p.value.state?.columns[d.data], F = f.filter.type === "selector", k = {
            ...
            }, b = o.fields.find((R) => R.name === k.field);
            d === "rvRowIndex" || d === "rvSymbol" || d === "rvInteractive" ? yt(k, le.value, p.value.state) : (n.indexOf(b.type) > -1 ? (gt(k, p.value.state), k.filter = "agNumberColumnFilter", k.autoHeight = !0, k.cellRenderer = f.template === "" ? Ve : e.component(f.template), k.cellRendererParams = {
              type: "number"
            }) : b.type === re.DATE ? (vt(k, p.value.state), k.filter = "agDateColumnFilter", k.autoHeight = !0, k.minWidth = 400, k.cellRenderer = f.template === "" ? Ve : e.component(f.template), k.cellRendererParams = {
              type: "date"
            }) : b.type === re.STRING && (F ? ft(k, o.rows, p.value.state) : ht(k, p.value.state), k.filter = "agTextColumnFilter", k.autoHeight = !0, k.cellRenderer = f.template === "" ? Ve : e.component(f.template), k.cellRendererParams = {
              type: "string"
            }), le.value.push(k));
    ...
    return X(() => {
      ...
      }, qe(), U.value === "partial" && e.notify.show(Xe.WARNING, e.$i18n.t("layer.filterwarning")), ye.value.push(
        Ie(C, () => {
      ...
      je(), W.value.forEach((a) => e.event.off(a)), ye.value.forEach((a) => a()), ke.value?.removeAccessibilityListeners(), ke.value?.removeScrollListeners(), m.value?.removeEventListener("keyup", We), m.value?.removeEventListener("blur", Ye);
    }), (a, t) => {
      ...
      return _(), E("div", {
        ...
        A(s("div", null, [
          s("p", jl, S(g(h)("grid.splash.error")), 1)
        ], 512), [
          [ae, te.value]
        ]),
        A(s("div", ql, [
          s("div", Wl, [
            s("span", Yl, S(ue.value.reduce((f, F) => f + F, 0)), 1),
            t[12] || (t[12] = s("svg", {
            ...
            s("span", Zl, S(Me.value), 1)
          ]),
          s("div", Ql, [
            s("span", Xl, S(ue.value.reduce((f, F) => f + F, 0) < Me.value ? g(h)("grid.splash.loading") : g(h)("grid.splash.building")), 1)
          ]),
          s("div", null, [
            s("button", {
              type: "button",
        ...
        A(s("div", ea, [
          s("div", ta, [
            ...
            A((_(), E("div", aa, [
              ne(S((!Be.value && z.value.visibleRows === 0 ? `${g(h)("grid.filters.label.hidden")} — ` : "") + g(h)("grid.filters.label.info", {
                range: z.value.visibleRows !== 0 ? `${z.value.firstRow} - ${z.value.lastRow}` : "0",
                total: z.value.visibleRows
              })) + " ", 1),
              z.value.visibleRows !== de.value.length && Be.value ? (_(), E("span", ra, S(g(h)("grid.filters.label.filtered", {
                max: de.value.length
              })), 1)) : D("", !0)
            ])), [
              [o]
                ...
                default: se(() => [
                  s("a", {
                    ...
                    s("div", va, [
                      ...
                      s("span", fa, S(g(h)("grid.label.filters.apply")), 1),
                  ...
                  s("a", {
                    ...
                    s("div", ya, [
                      ...
                      s("span", ba, S(g(h)("grid.label.filters.show")), 1),
                  ...
                  s("a", {
                    ...
                    s("div", Ca, [
                      ...
                      s("span", La, S(g(h)("grid.filters.label.extent")), 1),
                  ...
                  s("a", {
                    ...
                    s("div", Ma, [
                      ...
                      ]))) : c.value ? D("", !0) : (_(), E("svg", ka, t[24] || (t[24] = [
                      ...
                      s("span", Aa, S(g(h)("grid.label.pinColumns")), 1),
                  ...
                  s("a", {
                    ...
                    s("div", Ra, [
                      ...
                      s("span", Sa, S(g(h)("grid.label.export")), 1)
                    ])
                  ], 8, $a)
                ]),
                _: 1
...
}), Ga = /* @__PURE__ */ he(Ia, [["__scopeId", "data-v-911238ea"]]), Va = /* @__PURE__ */ G({
  __name: "screen",
  props: {
    panel: {
      type: rt,
  ...
  setup(L) {
    const n = st(), { t: e } = O(), r = I(() => n.currentId);
    return (l, i) => {
      const c = Pe("panel-screen");
      return _(), tt(c, { panel: L.panel }, {
        header: se(() => [
          ne(S(g(e)("grid.title")), 1)
        ]),
        content: se(() => [
          Ee(Ga, {
            class: "rv-grid",
...
}), Fr = /* @__PURE__ */ he(Va, [["__scopeId", "data-v-904e67ef"]]);
export {
  Fr as default
};
