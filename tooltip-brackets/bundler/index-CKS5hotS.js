...
import { _ as H, d as L, F as K, G as X } from "./main-DW-aGpyp.js";
...
const G = /* @__PURE__ */ H(te, [["render", ne]]), ie = /* @__PURE__ */ I({
  ...
  setup(f) {
    const i = S("iApi"), { t } = B(), o = ee(), p = [
      {
        type: "point",
        icon: g(_(() => import("./point-icon-Dy3Tvhk4.js")))
      },
      {
        type: "polyline",
        icon: g(_(() => import("./polyline-icon-xWofFTIA.js")))
      },
      {
        type: "polygon",
        icon: g(_(() => import("./polygon-icon-WODjCaVZ.js")))
      },
      {
        type: "circle",
        icon: g(_(() => import("./circle-icon-CNK0Ehp_.js")))
      },
      {
        type: "rectangle",
        icon: g(_(() => import("./rectangle-icon-CUD2BBHB.js")))
      }
    ], a = M(() => {
      const s = p.filter((u) => o.supportedTypes.some((x) => x.type === u.type));
      return s.push({
        type: "edit",
        icon: g(_(() => import("./edit-icon-BxhizFxx.js")))
      }), s;
    }), n = (s) => {
