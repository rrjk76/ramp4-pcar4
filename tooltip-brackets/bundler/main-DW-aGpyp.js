...
const Oo = ["content"], ko = {
  ...
  setup(s, { expose: e }) {
    ...
    return Je(() => {
      ...
      return M((v(), A("div", {
        ...
        s.header ? (v(), A("header", ko, [
          ne(T, {
            class: ie(s.panel.teleport ? "display-none" : "block sm:display-none"),
            onClick: $[0] || ($[0] = (R) => s.panel.close())
          }, null, 8, ["class"]),
          M((v(), A("h2", Mo, [
            b.$slots.header ? Me(b.$slots, "header", { key: 0 }) : (v(), A("div", Po, U(I(t)(s.panel.alertName)), 1))
          ])), [
            [Gt]
          ]),
          ...
          m("div", {
            ...
            s.panel.teleport ? V("", !0) : (v(), A("div", No, [
              d.value ? (v(), W(F, {
                key: 0,
...
}), Uo = { class: "relative" }, Vo = ["content", "aria-label"], Bo = ["transform"], zo = /* @__PURE__ */ O({
  __name: "pin",
  props: {
    active: Boolean
  },
...
}), qo = { class: "relative" }, jo = ["content", "aria-label"], Wo = /* @__PURE__ */ O({
  __name: "close",
  props: {
    active: Boolean
  },
...
}), Ko = { class: "w-32 h-32" }, Zo = ["content", "aria-label"], Xo = {
  key: 0,
  xmlns: "http://www.w3.org/2000/svg",
  viewBox: "0 0 24 24",
...
}), ra = { class: "relative" }, oa = ["content", "aria-label"], aa = /* @__PURE__ */ O({
  __name: "right",
  props: {
    active: Boolean
  },
...
}), na = { class: "relative" }, la = ["content", "aria-label"], ca = /* @__PURE__ */ O({
  __name: "left",
  props: {
    active: Boolean
  },
...
}), pa = /* @__PURE__ */ Ne(ua, [["__scopeId", "data-v-51e22a4a"]]), da = {
  key: 0,
  xmlns: "http://www.w3.org/2000/svg",
  viewBox: "0 0 24 24",
  ...
  setup(s) {
    ...
    return (r, o) => {
      ...
      return v(), W(a, {
        ...
        default: se(() => [
          I(t).isFullscreen ? (v(), A("svg", da, o[0] || (o[0] = [
            m("path", {
              d: "M0 0h24v24H0z",
              fill: "none"
            }, null, -1),
  ...
  tabindex: "-1"
}, va = ["content", "aria-label"], ba = /* @__PURE__ */ O({
  __name: "button",
  props: {
    onClickFunction: {
      type: Function,
  ...
  class: "relative",
  tabindex: "-1"
}, Aa = ["aria-label", "content"], Ea = /* @__PURE__ */ O({
  __name: "button",
  props: {
    onClickFunction: {
      type: Function,
...
}), xa = /* @__PURE__ */ Ne(Ea, [["__scopeId", "data-v-1cb84ae1"]]), Sa = B("areas-of-interest", () => ({ areas: f([]) })), Ia = B("export", () => {
  const s = f({
    title: !0,
    map: !0,
    mapElements: !0,
...
class Ra {
  ...
  fsaToProvince(e) {
    ...
    return r === "X" ? i === "X0A" || i === "X0B" || i === "X0C" ? t = 62 : t = 61 : t = Ta[r], this.codeToProvince(t);
  }
}
function $a(s) {
  return new Ra(s);
...
async function ka(s, e) {
  ...
  return r.test(e) && !s.disabledSearchTypes.includes("LAT/LNG") ? (i = e.slice(0, -1), t = new xt(s, i), await Na(t)) : a.test(e) && !s.disabledSearchTypes.includes("FSA") ? (i = e.substring(0, 3).toUpperCase(), t = new xt(s, i), await Fa(t)) : o.test(e) && !s.disabledSearchTypes.includes("NTS") ? (i = e.substring(0, 6).toUpperCase(), t = new xt(s, i), await Da(t)) : (i = encodeURIComponent(e.trim()), t = new xt(s, i), await Ga(t)), t;
}
const ri = async (s) => {
  ...
  const e = s.config;
  if (await Ma(s), e.categories.length === 0 || e.categories.includes("ADDR")) {
...
}, Ua = "~FSA~", xi = "https://geogratis.gc.ca/services/geolocation/@{language}/locate", Si = "https://geogratis.gc.ca/services/geoname/@{language}/geonames.json", Ii = "https://geogratis.gc.ca/services/geoname/@{language}/codes/province.json", _i = "https://geogratis.gc.ca/services/geoname/@{language}/codes/concise.json";
class Ti {
  config;
  constructor(e, t) {
    let i, r, o, a;
    ...
    if (c && c.serviceUrl) {
      ...
      n = `${c.serviceUrl}/query/?where=${w}%3D'${Ua}'&outFields=${w}&returnGeometry=true&f=json`;
    }
    const u = t?.settings;
    let p, d, g, h, y;
   ...
   */
  async query(e) {
    const t = await ka(this.config, e.toUpperCase()), i = this.config.sortOrder.length, r = t.results.filter((n) => n.order < i), o = t.results.filter((n) => n.order >= i);
...
var za = /* @__PURE__ */ ((s) => (s.Title = "title", s.Text = "text", s.Image = "image", s.Markdown = "markdown", s.Template = "template", s))(za || {});
class Ri extends is {
  _infoType;
...
function Xa(s, e) {
  ...
  r.directive("focus-container", Io), r.directive("focus-list", wo), r.directive("focus-item", Eo), r.directive("truncate", Ro), r.component("panel-screen", Go), r.component("pin", zo), r.component("close", Wo), r.component("back", Jo), r.component("expand", ea), r.component("panel-options-menu", pa), r.component("dropdown-menu", ii), r.component("minimize", sa), r.component("right", aa), r.component("left", ca), r.component("fullscreen-nav-button", fa), r.component("geolocator-nav-button", ma), r.component("home-nav-button", ya), r.component("mapnav-button", ba), r.component("appbar-button", xa), r.component("transition", Pi), r.component("transition-group", Ni), r.config.globalProperties.$iApi = e, r.config.globalProperties.$pinia = t, r.config.idPrefix = `ramp-${s.id || We.sharedUtils.generateUUID()}`, r.provide("iApi", e);
  const o = r.mount(s);
...
const rn = { geometryType: "point", renderer: { type: "simple", symbol: { type: "esriSMS", style: "esriSMSCircle", color: [67, 100, 255, 200], size: 7, outline: { color: [0, 0, 0, 255], width: 1 } } } }, on = { geometryType: "polyline", renderer: { type: "simple", symbol: { type: "esriSLS", style: "esriSLSSolid", color: [90, 90, 90, 200], width: 2 } } }, an = { geometryType: "polygon", renderer: { type: "simple", symbol: { type: "esriSFS", style: "esriSFSSolid", color: [76, 76, 125, 200], outline: { type: "esriSLS", style: "esriSLSSolid", color: [110, 110, 110, 255], width: 1 } } } }, nn = { geometryType: "polygon", renderer: { type: "simple", symbol: { type: "esriSFS", style: "esriSFSSolid", color: [255, 0, 0, 64], outline: { type: "esriSLS", style: "esriSLSSolid", color: [240, 128, 128, 255], width: 1 } } } }, ln = {
  circlePoint: rn,
  solidLine: on,
  outlinedPoly: an,
  boundingBoxPoly: nn
...
class rs extends ss {
  ...
  async onInitiate() {
    if (this.sourceJson) {
      ...
      this.attribs.attLoader = new Gn(this.$iApi, o), await this.attribs.attLoader.getAttribs(), this.featureCount = e.data.length;
...
class jn extends J {
   ...
   */
  constructor(e) {
    super(e), this.geom = We.geom, this.proj = We.proj, this.shared = We.sharedUtils, this.map = new sn(e), this.layer = new gn(e), this.attributes = new Fn(e), this.query = new qn(e), this.symbology = new zn(e), Array.isArray(ft.request.interceptors) || (ft.request.interceptors = []), ft.request.interceptors.push({
      before: (t) => {
...
const Wn = /* @__PURE__ */ Object.assign({ "../fixtures/appbar/index.ts": () => import("./index-CpTzMBaX.js"), "../fixtures/areas-of-interest/index.ts": () => import("./index-DulH3P_4.js"), "../fixtures/basemap/index.ts": () => import("./index-C-gCN6Nc.js"), "../fixtures/crosshairs/index.ts": () => import("./index-wHMtuCtI.js"), "../fixtures/details/index.ts": () => import("./index-iqydNlnW.js"), "../fixtures/draw/index.ts": () => import("./index-CFV74W_I.js"), "../fixtures/export-footnote/index.ts": () => import("./index-DQ9JwWKL.js"), "../fixtures/export-legend/index.ts": () => import("./index-BG8H1ynJ.js"), "../fixtures/export-map/index.ts": () => import("./index-Cc63iHbm.js"), "../fixtures/export-northarrow/index.ts": () => import("./index-DJ2M_BxA.js"), "../fixtures/export-scalebar/index.ts": () => import("./index-BKlZ0Ndy.js"), "../fixtures/export-timestamp/index.ts": () => import("./index-p4_4FYln.js"), "../fixtures/export-title/index.ts": () => import("./index-Ojn78va3.js"), "../fixtures/export/index.ts": () => import("./index-BnhaisES.js"), "../fixtures/extentguard/index.ts": () => import("./index-FMffwC6h.js"), "../fixtures/gazebo/index.ts": () => import("./index-RHUNfxeS.js"), "../fixtures/geosearch/index.ts": () => import("./index-C9K0SxF_.js"), "../fixtures/grid/index.ts": () => import("./index-tsHY-Upd.js"), "../fixtures/help/index.ts": () => import("./index-PBGRJwGd.js"), "../fixtures/hilight/index.ts": () => import("./index-DlQtNArH.js"), "../fixtures/layer-reorder/index.ts": () => import("./index-CcO70YHh.js"), "../fixtures/legend/index.ts": () => import("./index-DpHrthZE.js"), "../fixtures/mapnav/index.ts": () => import("./index-CKS5hotS.js"), "../fixtures/metadata/index.ts": () => import("./index-CVQ6Ns6S.js"), "../fixtures/northarrow/index.ts": () => import("./index-_oW3E89j.js"), "../fixtures/overviewmap/index.ts": () => import("./index-8Df0Nqqc.js"), "../fixtures/panguard/index.ts": () => import("./index-CNbrrMwA.js"), "../fixtures/scrollguard/index.ts": () => import("./index-DRFftWgj.js"), "../fixtures/settings/index.ts": () => import("./index-CV1h3p2p.js"), "../fixtures/snowman/index.ts": () => import("./index-CwLjzj_O.js"), "../fixtures/swipe/index.ts": () => import("./index-7P7iPxnP.js"), "../fixtures/wizard/index.ts": () => import("./index-CnnO2ZPY.js") });
class Hn extends J {
  /**
...
const Xn = /* @__PURE__ */ Ne(Kn, [["render", Zn], ["__scopeId", "data-v-a3c61802"]]), Qn = /* @__PURE__ */ Object.assign({ "../fixtures/areas-of-interest/screen.vue": () => import("./screen-C4_KYBA3.js"), "../fixtures/basemap/screen.vue": () => import("./screen-CFG9Sqbo.js"), "../fixtures/export/screen.vue": () => import("./screen-DYh05VE3.js"), "../fixtures/geosearch/screen.vue": () => import("./screen-CBfbiOTQ.js"), "../fixtures/grid/screen.vue": () => import("./screen-B6H4cG8U.js"), "../fixtures/help/screen.vue": () => import("./screen-CnRPQz1J.js"), "../fixtures/layer-reorder/screen.vue": () => import("./screen-4MErkVcj.js"), "../fixtures/legend/screen.vue": () => import("./screen-C63Ja5Dc.js"), "../fixtures/metadata/screen.vue": () => import("./screen-Dp13dvU0.js"), "../fixtures/settings/screen.vue": () => import("./screen-D1s-cTXe.js"), "../fixtures/wizard/screen.vue": () => import("./screen-BJczHqMS.js") });
class St extends J {
  /**
   * ID of this panel.
   *
...
function il(s) {
  ...
  return rl(s.services, e), sl(s.map, e), ol(s.ui, e), s.plugins && al(s.plugins, e), e;
}
function sl(s, e) {
...
var ot = { major: "4", minor: "14", patch: "0-beta", timestamp: "Wed Sep 24 15:36:04 2025 -0400", hash: "22b4565013d78bc14976a13c645c035ade4a29ba" };
console.info(
...
const Yl = (s, e, t) => new Za(s, e, t), We = new zs();
export {
  H as $,
  Gr as A,
  yt as B,
