...
import { _ as H, d as L, F as X, G as ee } from "./main-B0u1ZUZk.js";
...
const G = /* @__PURE__ */ H(ne, [["render", ae]]), se = /* @__PURE__ */ T({
  ...
  setup(h) {
    ...
    const p = [
      {
        type: "point",
        icon: g(_(() => import("./point-icon-B3Yo0xey.js")))
      },
      {
        type: "polyline",
        icon: g(_(() => import("./polyline-icon-BxhQrpYa.js")))
      },
      {
        type: "polygon",
        icon: g(_(() => import("./polygon-icon-cuxb7NOt.js")))
      },
      {
        type: "circle",
        icon: g(_(() => import("./circle-icon-CJ3qz8sb.js")))
      },
      {
        type: "rectangle",
        icon: g(_(() => import("./rectangle-icon-9QiMNO7F.js")))
      }
    ], a = A(() => {
      const s = p.filter((u) => e.supportedTypes.some((x) => x.type === u.type));
      return s.push({
        type: "edit",
        icon: g(_(() => import("./edit-icon-MgmOPlJb.js")))
      }), s;
    }), n = (s) => {
