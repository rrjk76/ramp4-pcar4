...
import { _ as H, d as L, F as X, G as ee } from "./main--05wUi4f.js";
...
const G = /* @__PURE__ */ H(oe, [["render", ie]]), ae = /* @__PURE__ */ S({
  ...
  setup(f) {
    ...
    const p = [
      {
        type: "point",
        icon: g(_(() => import("./point-icon-BOXm9vC6.js")))
      },
      {
        type: "polyline",
        icon: g(_(() => import("./polyline-icon-fUUprd-Y.js")))
      },
      {
        type: "polygon",
        icon: g(_(() => import("./polygon-icon-BPNOmF_f.js")))
      },
      {
        type: "circle",
        icon: g(_(() => import("./circle-icon-D8MuwGiL.js")))
      },
      {
        type: "rectangle",
        icon: g(_(() => import("./rectangle-icon-CSMX8LoA.js")))
      }
    ], a = A(() => {
      const s = p.filter((u) => e.supportedTypes.some((x) => x.type === u.type));
      return s.push({
        type: "edit",
        icon: g(_(() => import("./edit-icon-BGkdPe-H.js")))
      }), s;
    }), n = (s) => {
