...
import { _ as H, d as L, F as X, G as ee } from "./main-Cu4on34O.js";
...
const G = /* @__PURE__ */ H(oe, [["render", ie]]), ae = /* @__PURE__ */ S({
  ...
  setup(f) {
    ...
    const p = [
      {
        type: "point",
        icon: g(_(() => import("./point-icon-BbSOZBpk.js")))
      },
      {
        type: "polyline",
        icon: g(_(() => import("./polyline-icon-B9oCha6t.js")))
      },
      {
        type: "polygon",
        icon: g(_(() => import("./polygon-icon-BicjNf9l.js")))
      },
      {
        type: "circle",
        icon: g(_(() => import("./circle-icon-C1LaqRf1.js")))
      },
      {
        type: "rectangle",
        icon: g(_(() => import("./rectangle-icon-BZ-Q6H7n.js")))
      }
    ], a = A(() => {
      const s = p.filter((u) => e.supportedTypes.some((x) => x.type === u.type));
      return s.push({
        type: "edit",
        icon: g(_(() => import("./edit-icon-xQt1EWDn.js")))
      }), s;
    }), n = (s) => {
