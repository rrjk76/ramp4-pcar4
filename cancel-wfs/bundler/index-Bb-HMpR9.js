...
import "tiny-emitter";
import { G as le, L as Te, F as xe } from "./main-Cu4on34O.js";
...
class ft extends Me {
  async init() {
    Object.entries(Le).forEach((b) => this.$iApi.$i18n.mergeLocaleMessage(...b)), this._parseConfig(this.config), Z(this.$vApp.$pinia).supportedTypes.forEach((b) => {
      const o = `${b.type}-icon`;
      this.$iApi.component(o, Ae(Se(/* @__PURE__ */ Object.assign({ "./icons/circle-icon.vue": () => import("./circle-icon-C1LaqRf1.js"), "./icons/edit-icon.vue": () => import("./edit-icon-xQt1EWDn.js"), "./icons/point-icon.vue": () => import("./point-icon-BbSOZBpk.js"), "./icons/polygon-icon.vue": () => import("./polygon-icon-BicjNf9l.js"), "./icons/polyline-icon.vue": () => import("./polyline-icon-B9oCha6t.js"), "./icons/rectangle-icon.vue": () => import("./rectangle-icon-BZ-Q6H7n.js") }), `./icons/${b.type}-icon.vue`, 3)));
    });
