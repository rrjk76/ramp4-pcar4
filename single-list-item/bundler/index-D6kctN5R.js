...
import { _ as H, d as L, F as X, G as ee } from "./main-DBLUkQhP.js";
...
const G = /* @__PURE__ */ H(ne, [["render", ae]]), se = /* @__PURE__ */ T({
  ...
  setup(h) {
    ...
    const p = [
      {
        type: "point",
        icon: g(_(() => import("./point-icon-BapNwaqe.js")))
      },
      {
        type: "polyline",
        icon: g(_(() => import("./polyline-icon-WUacZ0n7.js")))
      },
      {
        type: "polygon",
        icon: g(_(() => import("./polygon-icon-UY1JrIU6.js")))
      },
      {
        type: "circle",
        icon: g(_(() => import("./circle-icon-Da-WkeQ2.js")))
      },
      {
        type: "rectangle",
        icon: g(_(() => import("./rectangle-icon-B6dr9G3_.js")))
      }
    ], a = A(() => {
      const s = p.filter((u) => e.supportedTypes.some((x) => x.type === u.type));
      return s.push({
        type: "edit",
        icon: g(_(() => import("./edit-icon-B9E-_Vm7.js")))
      }), s;
    }), n = (s) => {
