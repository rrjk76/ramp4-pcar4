...
import "tiny-emitter";
import { G as le, L as Te, F as xe } from "./main-BbebaOuU.js";
...
class ft extends Me {
  async init() {
    Object.entries(Le).forEach((b) => this.$iApi.$i18n.mergeLocaleMessage(...b)), this._parseConfig(this.config), Z(this.$vApp.$pinia).supportedTypes.forEach((b) => {
      const o = `${b.type}-icon`;
      this.$iApi.component(o, Ae(Se(/* @__PURE__ */ Object.assign({ "./icons/circle-icon.vue": () => import("./circle-icon-DhvNz0ym.js"), "./icons/edit-icon.vue": () => import("./edit-icon-BX0JWGRj.js"), "./icons/point-icon.vue": () => import("./point-icon-CDkdNjyb.js"), "./icons/polygon-icon.vue": () => import("./polygon-icon-B77jvwEy.js"), "./icons/polyline-icon.vue": () => import("./polyline-icon-BKwLwkGR.js"), "./icons/rectangle-icon.vue": () => import("./rectangle-icon-CDSHpQ8b.js") }), `./icons/${b.type}-icon.vue`, 3)));
    });
