import { defineComponent as I, inject as ie, resolveComponent as He, createBlock as et, openBlock as _, unref as f, withCtx as se, createElementBlock as E, Fragment as tt, renderList as lt, createElementVNode as s, createTextVNode as ne, createCommentVNode as S, toDisplayString as D, ref as w, onBeforeMount as ve, withDirectives as A, withKeys as V, withModifiers as H, normalizeClass as N, vModelText as oe, vModelSelect as kt, onMounted as X, nextTick as _e, onBeforeUnmount as J, resolveDirective as U, computed as P, useTemplateRef as Ft, getCurrentInstance as At, watch as Ge, vShow as ae, createVNode as Ee, markRaw as Pe } from "vue";
import "tiny-emitter";
import { a as fe, _ as ge, G as Q, W as Tt, X as $t, L as Rt, Y as Dt, Z as at, $ as re, i as rt, a0 as Qe, a1 as Le, a2 as St } from "./main-BbebaOuU.js";
...
const Wt = ["onClick"], Yt = { class: "md-icon-small inline" }, Zt = {
  key: 0,
  height: "18",
  width: "18",
  viewBox: "0 0 24 24",
  ...
  setup(L) {
    const n = ie("iApi"), { t: e } = B();
    return (a, l) => {
      const o = He("dropdown-menu");
      return _(), et(o, {
        class: "relative",
        position: "bottom-end",
        ...
        default: se(() => [
          (_(!0), E(tt, null, lt(L.columnDefs.filter(
            (d) => d.headerName && d.headerName.length > 0 && !(!f(n).ui.exposeOids && L.systemCols?.has(d.headerName)) && !(!f(n).ui.exposeMeasurements && (L.systemCols?.has(d.headerName) || L.systemCols?.has(d.field)))
          ), (d) => (_(), E("a", {
            key: d.headerName,
            onClick: (p) => {
  ...
  props: ["params"],
  setup(L) {
    const n = fe(), { t: e } = B(), a = L, l = w(""), o = w(""), d = w(a.params.stateManager.columns[a.params.column.colDef.field].filter.static), p = () => {
    ...
    return ve(() => {
      ...
      A(s("input", {
        ...
        onInput: y[1] || (y[1] = (x) => p()),
        onMousedown: y[2] || (y[2] = H(() => {
        }, ["stop"])),
        onKeypress: y[3] || (y[3] = V(H(() => {
        }, ["prevent"]), ["enter"])),
        onKeyup: y[4] || (y[4] = V((x) => {
      ...
      A(s("input", {
        ...
        onInput: y[6] || (y[6] = (x) => m()),
        onMousedown: y[7] || (y[7] = H(() => {
        }, ["stop"])),
        onKeypress: y[8] || (y[8] = V(H(() => {
        }, ["prevent"]), ["enter"])),
        onKeyup: y[9] || (y[9] = V((x) => {
          f(n).mobileView && x.target.blur();
        }, ["enter"])),
  ...
  props: ["params"],
  setup(L) {
    const n = fe(), { t: e } = B(), a = L, l = w(""), o = w(a.params.stateManager.columns[a.params.column.colDef.field].filter.static), d = () => {
    ...
    return ve(() => {
      ...
      A(s("input", {
        ...
        onMousedown: m[2] || (m[2] = H(() => {
        }, ["stop"])),
        onKeypress: m[3] || (m[3] = V(H(() => {
        }, ["prevent"]), ["enter"])),
        onKeyup: m[4] || (m[4] = V((h) => {
  ...
  props: ["params"],
  setup(L) {
    const n = L, { t: e } = B(), a = w(), l = w(), o = w(), d = () => n.params.clearFilters();
    return X(async () => {
  ...
  props: ["params"],
  setup(L) {
    const { t: n } = B(), e = L, a = w(), l = w(0), o = w(!1), d = w(!1), p = w(!1), m = w(null), h = () => {
  ...
  props: ["params"],
  setup(L) {
    const n = L, { t: e } = B(), a = ie("iApi"), l = w(), o = async () => {
      const d = n.params.data, p = d.rvUid, m = a.geo.layer.getLayer(p), h = m.oidField, y = n.params.layerCols[m.id].find(
        (c) => c.origAttr === h
      )?.mappedAttr || h, x = await m.getGraphic(d[y], {
        getAttribs: !0
      });
      a.event.emit(
        Q.DETAILS_TOGGLE,
  ...
  props: ["params"],
  setup(L) {
    const n = w("none"), e = L, a = ie("iApi"), l = $t(), o = w(), { t: d } = B(), p = P(() => {
      ...
      const y = e.params.layerCols[C.id].find((M) => M.origAttr === C.oidField), x = e.params.data[y ? y.mappedAttr ?? y.origAttr : C.oidField], c = () => {
        const M = { getGeom: !0 };
    ...
    return X(() => {
      ...
      return p.value ? A((_(), E("button", {
        ...
        type: "button",
        class: "flex items-center justify-center w-40 h-36",
        content: f(d)(`grid.cells.zoom${n.value === "none" ? "" : `.${n.value}`}`),
        onClick: m,
        tabindex: "-1",
        ref_key: "button",
        ref: o,
        "aria-label": f(d)(`grid.cells.zoom${n.value === "none" ? "" : `.${n.value}`}`)
      }, [
  ...
  setup(L) {
    const n = L, e = ie("iApi"), a = w(), l = P(() => {
      ...
      const d = Object.assign({}, n.params.data), p = e.geo.layer.getLayer(d.rvUid), m = n.params.layerCols[p.id].find((C) => C.origAttr === p.oidField), h = m.mappedAttr ? d[m.mappedAttr] : d[m.origAttr];
      p.getGraphic(h, { getAttribs: !0 }).then((C) => {
  ...
  props: ["params"],
  setup(L) {
    const n = fe(), e = ie("iApi"), { t: a } = B(), l = w(), o = w(), d = w(!1), p = L, m = P(() => n.mobileView), h = () => {
      o.value?.textContent && (d.value = !0, l.value?._tippy.show(), navigator.clipboard.writeText(o.value?.textContent), setTimeout(() => {
        d.value = !1;
      }, 2e3));
    }, C = P(() => p.params.type === "number" ? p.params.value == null ? "" : e.ui.formatNumber(p.params.value) : p.params.type === "date" ? p.params.value == null ? "" : new Date(p.params.value).toISOString().slice(0, 10) : p.params.type === "string" ? !p.params.value || /<a[^>]*>[^<]+<\/a>/g.test(p.params.value) ? p.params.value : It(p.params.value, {
      target: "_blank",
      validate: {
        url: (x) => /^https?:\/\//.test(x)
        // only links that begin with a protocol will be hyperlinked
      }
    }) : ""), y = P(() => /<a[^>]*>[^<]+<\/a>/g.test(p.params.value) || /(http(s)?:\/\/.*)/g.test(p.params.value));
    return X(() => {
      ...
      return _(), E("div", null, [
        ...
        o.value?.textContent ? A((_(), E("div", {
          ...
          ref_key: "copyTooltip",
          ref: l,
          content: f(a)(`grid.label.${d.value ? "copied" : "copy"}`)
        }, null, 8, Ul)), [
          [$, {
  ...
  setup(L) {
    ...
    const n = [re.OID, re.DOUBLE, re.SINGLE, re.INTEGER], e = ie("iApi"), a = rt(), l = fe(), o = P(() => l.mobileView), d = w(!o.value), p = w(), m = Ft("gridContainer"), { t: h, locale: C } = B(), y = () => At()?.proxy?.$forceUpdate(), x = L, c = w({
      id: "dummy",
      layerIds: [],
      state: new Pt(),
      fieldMap: {}
    }), M = w(!0), $ = w(null), K = w(), ee = w(), j = w(!1), te = w(!1), ue = w([]), Me = w(0), W = w([]), he = w([]), ke = w(""), le = w([]), de = w([]), ye = w("OBJECTID"), Fe = w(void 0), st = Je.onCellKeyPress, z = w({ firstRow: 0, lastRow: 0, visibleRows: 0 }), be = w({}), Ae = e.geo.layer.getLayer(x.gridId), pe = w({}), nt = w(a.grids[x.gridId].layerIds), G = P(() => a.grids[x.gridId] ? a.grids[x.gridId].layerIds.map((r) => e.geo.layer.getLayer(r)).filter((r) => r !== void 0) : []), Ne = P(() => c.value.state.filtered || c.value.state.searchFilter), Te = w(/* @__PURE__ */ new Set()), we = w([]), T = P(() => $.value), xe = () => {
      e.$vApp.$el.querySelectorAll(
        ".ag-input-field-input.ag-checkbox-input"
      ).forEach((t, g) => {
        const u = T.value.getAllDisplayedColumns()?.[g].getColDef();
        t.setAttribute("aria-label", u?.headerName ?? h("grid.label.specialColumn"));
      });
    }, ot = (r) => {
      $.value = r.api, ke.value = c.value.state.title || Ae?.name || x.gridId, Re(), de.value.length > 0 && T.value.autoSizeAllColumns(), xe(), T.value.addEventListener("rowDataUpdated", xe), W.value.push(
        e.event.on(Q.FILTER_CHANGE, ({ uid: t, filterKey: g }) => {
          g !== Le.GRID && t && G.value.map((i) => i.uid).includes(t) && Y();
        })
      ), W.value.push(
        e.event.on(
      ...
      T.value.autoSizeAllColumns(), Fe.value = new Je(p.value, $.value), xe();
    }, $e = () => {
      ...
      $.value && !j.value && (c.value.state.searchFilter !== "" && $e(), c.value.state.applyToMap && De(), _e(() => {
      ...
      const r = T.value.getAllDisplayedColumns().filter((i) => !i.getColDef().headerComponentParams?.preventExport), t = document.createElement("p"), g = (i) => (t.innerHTML = i, t.textContent || t.innerText);
      ...
      r.floatingFilterComponent = "dateFloatingFilter", r.filterParams.comparator = function(g, i) {
        const u = new Date(i);
        return u.getUTCFullYear() > g.getUTCFullYear() ? 1 : u.getUTCFullYear() < g.getUTCFullYear() ? -1 : u.getUTCMonth() > g.getUTCMonth() ? 1 : u.getUTCMonth() < g.getUTCMonth() ? -1 : u.getUTCDate() - g.getUTCDate();
      ...
      if (r.field === "rvInteractive") {
        ...
        if (i.includes("details") && t.push(u), Mt.value) {
          const v = {
            field: "rvZoomButton",
            headerName: "",
            headerComponentParams: { isStatic: !0, preventExport: !0 },
      ...
      c.value.state.applyToMap = !c.value.state.applyToMap, De();
    }, De = () => {
      ...
      if (Object.keys(t || {}).forEach((i) => {
        const u = Se(r, i);
        u ? g.push(Lt(u.origAttr, t?.[i])) : g.push("1=2");
      ...
      switch (t.filterType) {
        ...
        case "text": {
          ...
          if (g !== "") {
            const i = /\\[(!"#$&'+,.\\/:;<=>?@[\]^`{|}~)]/g;
            let u = g, v = "", k = i.exec(g), F = 0;
            for (; k; )
              v = v + g.substr(F, k.index - F) + k[0].slice(-1), F = k.index + 2, u = g.substr(k.index + 2), k = i.exec(g);
        ...
        case "date": {
          const g = new Date(t.dateFrom ?? 0), i = new Date(t.dateTo ?? 864e13), u = g ? `${g.getMonth() + 1}/${g.getDate()}/${g.getFullYear()}` : void 0, v = i ? `${i.getMonth() + 1}/${i.getDate()}/${i.getFullYear()}` : void 0;
          switch (t.type) {
      ...
      const g = c.value.state.searchFilter.replace(/'/g, "''").split(" "), i = [];
      ...
      r.length === 0 && Ue(), Me.value = r.reduce((t, { featureCount: g }) => t + g, 0), ue.value = new Array(G.value.length).fill(0), r.forEach((t, g) => ue.value[g] += t.downloadedAttributes()), r.forEach((t, g) => {
        ...
        const t = r.map((g) => Pe(g).getTabularAttributes().then((i) => {
        ...
        Promise.all(t).then((g) => {
          ...
          g.forEach((u, v) => {
            ...
            i.fields = i.fields.concat(
              u.fields.map((b) => ((!e.ui.exposeOids && b.type === "oid" || !e.ui.exposeMeasurements && (b.name.toLowerCase() === "shape_length" || b.name.toLowerCase() === "shape_area")) && Te.value.add(b.name), {
            ...
            c.value.state?.columns[u.data] === void 0 && (c.value.state.columns[u.data] = new Vt({
              field: u.data,
              title: u.title
            })), (!e.ui.exposeOids || !e.ui.exposeMeasurements) && Te.value.has(u.data) && (c.value.state.columns[u.data].visible = !1);
            ...
            u === "rvRowIndex" || u === "rvSymbol" || u === "rvInteractive" ? yt(F, le.value, c.value.state) : (n.indexOf(b.type) > -1 ? (gt(F, c.value.state), F.filter = "agNumberColumnFilter", F.autoHeight = !0, F.cellRenderer = v.template === "" ? Ve : e.component(v.template), F.cellRendererParams = {
              type: "number"
            }) : b.type === re.DATE ? (vt(F, c.value.state), F.filter = "agDateColumnFilter", F.autoHeight = !0, F.minWidth = 400, F.cellRenderer = v.template === "" ? Ve : e.component(v.template), F.cellRendererParams = {
              type: "date"
            }) : b.type === re.STRING && (k ? ft(F, i.rows, c.value.state) : ht(F, c.value.state), F.filter = "agTextColumnFilter", F.autoHeight = !0, F.cellRenderer = v.template === "" ? Ve : e.component(v.template), F.cellRendererParams = {
              type: "string"
            }), le.value.push(F));
          }), de.value = Pe(i.rows), le.value = Pe(le.value), Re(), j.value = !1;
        }).catch((g) => {
    ...
    return X(() => {
      ...
      c.value = a.grids[x.gridId], j.value = !0, y(), z.value = {
        firstRow: 0,
        lastRow: 0,
        visibleRows: 0
      }, ee.value = {
      ...
      }, je(), O.value === "partial" && e.notify.show(Qe.WARNING, e.$i18n.t("layer.filterwarning")), he.value.push(
        Ge(C, () => {
      ...
      const g = He("dropdown-menu"), i = U("truncate"), u = U("tippy");
      return _(), E("div", {
        ...
        A(s("div", Jl, [
          s("div", ea, [
            ...
            A((_(), E("div", la, [
              ne(D((!f(Ae).visibility && z.value.visibleRows === 0 ? `${f(h)("grid.filters.label.hidden")} — ` : "") + f(h)("grid.filters.label.info", {
                range: z.value.visibleRows !== 0 ? `${z.value.firstRow} - ${z.value.lastRow}` : "0",
                total: z.value.visibleRows
              })) + " ", 1),
              z.value.visibleRows !== de.value.length && f(Ae).visibility ? (_(), E("span", aa, D(f(h)("grid.filters.label.filtered", {
                max: de.value.length
              })), 1)) : S("", !0)
            ])), [
              [i]
          ...
          s("div", ra, [
            A(s("div", sa, [
              ...
              s("div", oa, [
                c.value.state.searchFilter.length < 3 ? (_(), E("svg", ia, t[13] || (t[13] = [
            ...
            s("div", da, [
              ...
              A((_(), E("button", {
                type: "button",
                class: N(["grid-clearall p-4 h-40", Ne.value ? "text-gray-500 hover:text-black" : "text-gray-300 cursor-default"]),
              ...
              Ee(g, {
                ...
                default: se(() => [
                  s("a", {
                    href: "javascript:;",
                    class: N(["leading-snug w-256", {
                      hover: O.value !== "disabled" ? "none" : "text-black",
                      disabled: O.value === "disabled"
                    }]),
                    onClick: t[7] || (t[7] = (v) => O.value !== "disabled" && xt()),
                    role: "button",
                    ...
                    s("div", ma, [
                      ...
                      O.value !== "disabled" && c.value.state.applyToMap ? (_(), E("svg", fa, t[17] || (t[17] = [
                        s("g", { id: "done" }, [
                          s("path", { d: "M9 16.2L4.8 12l-1.4 1.4L9 19 21 7l-1.4-1.4L9 16.2z" })
                        ], -1)
                      ]))) : S("", !0)
                  ...
                  s("a", {
                    ...
                    s("div", ha, [
                      ...
                      c.value.state.colFilter ? (_(), E("svg", ba, t[19] || (t[19] = [
                        s("g", { id: "done" }, [
                          s("path", { d: "M9 16.2L4.8 12l-1.4 1.4L9 19 21 7l-1.4-1.4L9 16.2z" })
                        ], -1)
                      ]))) : S("", !0)
                  ...
                  s("a", {
                    ...
                    onClick: t[9] || (t[9] = (v) => O.value !== "disabled" && dt()),
                    role: "button",
                    ...
                    s("div", xa, [
                      ...
                      O.value !== "disabled" && c.value.state.filterByExtent ? (_(), E("svg", La, t[21] || (t[21] = [
                        s("g", { id: "done" }, [
                          s("path", { d: "M9 16.2L4.8 12l-1.4 1.4L9 19 21 7l-1.4-1.4L9 16.2z" })
                        ], -1)
                      ]))) : S("", !0)
                  ...
                  s("a", {
                    href: "javascript:;",
                    class: N(["leading-snug w-256", { hover: "text-black" }]),
                    onClick: t[10] || (t[10] = (v) => ct()),
                    role: "button",
                    "aria-label": f(h)("grid.label.pinColumns")
                  }, [
                    s("div", Ea, [
                      d.value ? (_(), E("svg", Ma, t[23] || (t[23] = [
                      ...
                      ]))) : d.value ? S("", !0) : (_(), E("svg", ka, t[24] || (t[24] = [
  ...
  setup(L) {
    const n = rt(), { t: e } = B(), a = P(() => n.currentId);
    return (l, o) => {
      const d = He("panel-screen");
      return _(), et(d, { panel: L.panel }, {
        header: se(() => [
