...
import { _ as H, d as L, F as X, G as ee } from "./main-BbebaOuU.js";
...
const G = /* @__PURE__ */ H(oe, [["render", ie]]), ae = /* @__PURE__ */ S({
  ...
  setup(f) {
    ...
    const p = [
      {
        type: "point",
        icon: g(_(() => import("./point-icon-CDkdNjyb.js")))
      },
      {
        type: "polyline",
        icon: g(_(() => import("./polyline-icon-BKwLwkGR.js")))
      },
      {
        type: "polygon",
        icon: g(_(() => import("./polygon-icon-B77jvwEy.js")))
      },
      {
        type: "circle",
        icon: g(_(() => import("./circle-icon-DhvNz0ym.js")))
      },
      {
        type: "rectangle",
        icon: g(_(() => import("./rectangle-icon-CDSHpQ8b.js")))
      }
    ], a = A(() => {
      const s = p.filter((u) => e.supportedTypes.some((x) => x.type === u.type));
      return s.push({
        type: "edit",
        icon: g(_(() => import("./edit-icon-BX0JWGRj.js")))
      }), s;
    }), n = (s) => {
